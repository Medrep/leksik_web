...
export function PublicLayoutShell({ children }: PublicLayoutShellProps) {
  return (
    <div className="relative min-h-screen w-full min-w-0 max-w-full px-4 py-6 sm:px-6 sm:py-8">
      <div
      ...
      />
      <main className="relative z-10 mx-auto flex min-h-[calc(100vh-5rem)] w-full min-w-0 max-w-full items-center justify-center py-8 sm:max-w-6xl sm:py-10">
        {children}
      </main>
    </div>
  );
