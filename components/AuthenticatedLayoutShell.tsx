  ...
  return (
    <div className="relative min-h-screen w-full min-w-0 max-w-full overflow-x-clip px-4 py-5 sm:px-6 sm:py-6">
      ...
      {isPublicLocaleReady ? (
        ...
        <header
          aria-hidden="true"
          className="auth-appear relative z-10 mx-auto flex w-full min-w-0 max-w-full items-center justify-between gap-3 self-stretch border-b border-token-border pb-4 sm:max-w-6xl"
        >
          <div className="h-9 w-9 rounded-lg bg-token-border/60" />
          <div className="h-4 w-24 rounded bg-token-border/50" />
        </header>
      )}
